...
blogdown::shortcode("figure",
                    src = "myoolong.jpg",
                    title = "Jin Guan Yin leaves after two rounds of gentle bruising",
                    lightbox="true", width = "60%")
```
...
```{r}
blogdown::shortcode("figure", src = "shengzhou.jpg", width = "80%", lightbox = "true", title = "A view of the Shengzhou TRI Experimental Station")
```
...
```{r}
blogdown::shortcode("figure", src = "lixin-weijipeng.jpg", width = "60%", lightbox = "true", title = "Wei Ji-Peng (left), me (center), and Dr. Li Xin (right) at the Shengzhou experimental station")
```
...
```{r}
blogdown::shortcode("figure", src = "ming-ming.jpg", width = "60%", lightbox = "true", title = "Guo Ming-Ming, an undergraduate researcher visiting from Guangzhou for the summer")
```
